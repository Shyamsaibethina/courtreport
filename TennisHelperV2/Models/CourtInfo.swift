            ...
            HStack(alignment: .center, spacing: 70){
                HStack(spacing: 0){
                    ...
                    VStack(alignment: .trailing, spacing: 15){
                        Image(systemName: court.clay=="TRUE" ? "checkmark.circle.fill" : "x.circle.fill")
                            .foregroundColor(court.clay=="TRUE" ? .green : .red)
                            .font(.title)
                        
                        Image(systemName: court.grass=="TRUE" ? "checkmark.circle.fill" : "x.circle.fill")
                            .foregroundColor(court.grass=="TRUE" ? .green : .red)
                            .font(.title)
                        
                        Image(systemName: court.wall=="TRUE" ? "checkmark.circle.fill" : "x.circle.fill")
                ...
                VStack{
                    HStack{
                        ...
                        Image(systemName: court.indoor=="TRUE" ? "checkmark.circle.fill" : "x.circle.fill")
