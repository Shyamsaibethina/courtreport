...
@IBDesignable open class KRTournamentView: UIView, KRTournamentViewDataStore {
    ...
    public internal(set) var tournamentStructure: Bracket = Default.tournamentStructure

    /// Entry size. This is set by the delegate. Default is CGSize(80.0, 30.0).
    public internal(set) var entrySize: CGSize = Default.entrySize(with: Default.style)
...
extension KRTournamentView: KRTournamentViewDataSource {
    open func structure(of _: KRTournamentView) -> Bracket {
        return Default.tournamentStructure
    }

    open func tournamentView(_: KRTournamentView, entryAt _: Int) -> KRTournamentViewEntry {
        return Default.tournamentViewEntry
    }

    open func tournamentView(_: KRTournamentView, matchAt _: MatchPath) -> KRTournamentViewMatch {
