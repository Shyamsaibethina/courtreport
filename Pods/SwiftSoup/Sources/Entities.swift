...
public enum Entities {
    ...
    public class EscapeMode: Equatable {
        ...
        public static let xhtml: EscapeMode = .init(string: Entities.xhtml, size: 4, id: 0)
        /** Default HTML output entities. */
        public static let base: EscapeMode = .init(string: Entities.base, size: 106, id: 1)
        /** Complete HTML entities. */
        public static let extended: EscapeMode = .init(string: Entities.full, size: 2125, id: 2)
