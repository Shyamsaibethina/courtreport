...
class HtmlTreeBuilder: TreeBuilder {
    ...
    private var formattingElements: [Element?] = .init() // active (open) formatting elements
    private var pendingTableCharacters: [String] = .init() // chars in table to be shifted out
    private var emptyEnd: Token.EndTag = .init() // reused empty end tag
