...
open class Token {
    ...
    final class Doctype: Token {
        let name: StringBuilder = .init()
        var pubSysKey: String?
        let publicIdentifier: StringBuilder = .init()
        let systemIdentifier: StringBuilder = .init()
    ...
    class Tag: Token {
        ...
        private let _pendingAttributeValue: StringBuilder = .init() // but values are accumulated, from e.g. & in hrefs
        ...
        public var _attributes: Attributes = .init()
